...
namespace l7
{
    class RationalNumber : IEquatable<RationalNumber>
    {
        ...
        {
            int CommonDenominator = MyMath.LeastCommonMultiple(a._m, b._m);
            int NOD = Math.Abs(MyMath.GreatestCommonDivisor(a._n * CommonDenominator / a._m + b._n * CommonDenominator / b._m, CommonDenominator));
            return new RationalNumber((a._n * CommonDenominator / a._m + b._n * CommonDenominator / b._m) / NOD, CommonDenominator / NOD);
        }
        public static RationalNumber operator +(RationalNumber a, int b)
        {
            int NOD = Math.Abs(MyMath.GreatestCommonDivisor(a._n + b * a._m, a._n));
            return new RationalNumber((a._n + b * a._m) / NOD, a._m / NOD);
        }
        public static RationalNumber operator -(RationalNumber a, RationalNumber b)
        {
            int CommonDenominator = MyMath.LeastCommonMultiple(a._m, b._m);
        ...
        public static RationalNumber operator -(RationalNumber a, int b)
        {
            int NOD = Math.Abs(MyMath.GreatestCommonDivisor(a._n - b * a._m, a._m));
            return new RationalNumber((a._n - b * a._m) / NOD, a._m / NOD);
        }
        public static RationalNumber operator *(RationalNumber a, RationalNumber b)
        {
